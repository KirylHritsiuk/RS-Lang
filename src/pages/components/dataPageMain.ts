...
export const arrAdvantages: IArrAdvantages[] = [
  ...
  },
  {
    ...
    name: 'Games',
    text: 'For learning words and reinforcing memorization, the application has 2 games: Sprint, Audio Chalenge, which will help you to "pump" your vocabulary in a playful way.',
  },
  {
...
export const team:ITeam[] = [
  {
    ...
    contribution: 'Designed layout of the application, made main page and statistics, participated in the development of the group selector component.',
  ...
  },
  {
    ...
    speciality: 'Frontend developer',
    contribution: 'Developed "Audio Challenge" minigame, various common components for the minigames, router setup, login form, backend and the group selector component.',
  ...
  },
  {
    ...
    contribution: 'Did basic project settings, the development of the pages of the TextBook and Dictionary. Made a cards for words, implemented textbook settings and output of word statistics in the dictionary',
